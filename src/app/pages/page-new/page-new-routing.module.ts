...
const routes: Routes = [
  ...
  { path: 'enter', component: NewComponent, data: { reqType: RequestDocumentType.EnterWithOwner } },
  { path: 'import', component: NewComponent, data: { reqType: RequestDocumentType.ImportWithOwner } },
  { path: 'production', component: NewComponent, data: { reqType: RequestDocumentType.ProductionWithOwner } },
  { path: 'owning', component: NewComponent, data: { reqType: RequestDocumentType.Owner } },
  { path: 'substitute/:license_id', component: NewComponent, data: { reqType: RequestDocumentType.Substitute } },
  { path: 'sendsample', component: NewComponent, data: { reqType: RequestDocumentType.SendSample } },
  ...
  { path: 'renewal' + '/:type/:id', component: NewComponent, data: { reqType: RequestDocumentType.Renewal } },
  { path: 'renewal' + '/request/:id', component: NewComponent, data: { reqType: RequestDocumentType.Renewal } },
];
